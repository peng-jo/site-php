                    ...
                    <form action="boardModifySave.php" name="boardModify" method="post">
                        <fieldset>
                            ...
                            <?php
                                ...
                                $sql = "SELECT b.myBoardTitle, b.boardContent, m.youname FROM myBoard b JOIN member m ON (b.myMemberID = m.myMemberID) WHERE b.myBoardID = ${boardID}";
                                ...
                                if( $result ){
                                    ...
                                    echo "<input type='text' name='boardTitle' id='boardTitle' value='".$info['myBoardTitle']."'></div>";
                        ...
                        <button class="btn" input="submit" value="저장하기">저장하기</button>
                    </form>
                </section>
            </article>
        </section>
