                        ...
                        <div class="board-table">
                            <table>
                                ...
                                <?php
                                    ...
                                    //1 ~ 20 DESC LIMIT 0, 20   -> $page = 1 ($numView * $pages) - $numView
                                    //21 ~ 40 DESC LIMIT 20, 20 -> $page = 2
                                    //41 ~ 20 DESC LIMIT 40, 20 -> $page = 3
                                    //61 ~ 20 DESC LIMIT 60, 20 -> $page = 4
                                    //81 ~ 20 DESC LIMIT 80, 20 -> $page = 5


                                    $sql = "SELECT b.myBoardID, b.myBoardTitle, m.youName, b.boardView, b.regTime FROM gmember m JOIN gboard b ON (m.myMemberID = b.myMemberID) ORDER BY myBoardID DESC LIMIT {$ViewLimit}, {$numView}";
                                    ...
                                    if($result){
                                        ...
                                        if($count > 0){
                                            for($i=1; $i<=$count; $i++){
                                                ...
                                                echo "<td><a href='boardView.php?boardID={$info['myBoardID']}'>".$info['myBoardTitle']."</a></td>";
